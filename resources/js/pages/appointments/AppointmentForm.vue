...
const getAppointment = () => {
    ...
    .then(({data}) => {
        ...
        form.created_at = data.formatted_start_time;
        form.updated_at = data.formatted_end_time;
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.created_at" type="text" class="form-control flatpickr" :class="{'is-invalid': errors.created_at}" id="start-time">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.updated_at" type="text" class="form-control flatpickr" :class="{'is-invalid': errors.updated_at}" id="end-time">
